...
```bash
cosign verify --key cosign.pub ghcr.io/ontos-research/ontos/control-plane:0.1.44
cosign verify --key cosign.pub ghcr.io/ontos-research/ontos/secure-agent:0.1.44
```
